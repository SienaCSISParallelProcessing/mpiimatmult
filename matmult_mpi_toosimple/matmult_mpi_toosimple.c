...
int main(int argc, char *argv[]) {
  ...
  /* allocate A and C, which have mysize rows, size columns */
  ...
  /* allocate B, which has size rows and columns */
